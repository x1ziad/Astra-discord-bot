...
def main():
    ...
    print("\n🎯 SUMMARY:")
    print(
        "The issue is likely that Freepik API doesn't use standard Bearer token authentication."
    )
    print("The server is saying 'No API key provided' even though we're sending one.")
    print(
        "This suggests the API key is not being sent in the expected format/location."
    )
    print("\n🔧 ACTION REQUIRED:")
