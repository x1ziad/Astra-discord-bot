...
async def test_space_features():
    ...
    data_dirs = ["data", "data/space", "data/conversations", "data/analytics"]
    ...
    try:
        ...
        async with aiohttp.ClientSession() as session:
            ...
            print(
                f"  🔍 Testing with API key: {'Custom' if nasa_key != 'DEMO_KEY' else 'DEMO_KEY'}"
            )
        ...
        async with aiohttp.ClientSession() as session:
            ...
            async with session.get(
                ...
                if response.status == 200:
                    ...
                    print(
                        f"  👨‍🚀 People in space: {total_people}, ISS crew: {len(iss_crew)}"
                    )
                else:
    ...
    try:
        ...
        try:
            ...
            print(
                f"  🔧 Space content feature: {'Enabled' if space_enabled else 'Disabled'}"
            )
        except:
