...
def check_environment_variables():
    ...
    # Analysis
    print("\n📊 ANALYSIS:")
    print(f"  Discord Bot: {'✅ Ready' if other_variables['DISCORD_TOKEN'] else '❌ Missing DISCORD_TOKEN'}")
    print(f"  AI Conversation: {'✅ Ready' if ai_configured else '❌ Missing AI API key'}")
    print(f"  Image Generation: {'✅ Ready' if other_variables['FREEPIK_API_KEY'] else '❌ Missing FREEPIK_API_KEY'}")
