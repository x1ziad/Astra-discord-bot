...
class ImageGenerationHandler:
    ...
    async def is_available(self) -> bool:
        ...
        try:
            ...
            if available:
                ...
                logger.warning(f"❌ Image generation unavailable: {test_result.get('message', 'Unknown error')}")
    ...
    async def _check_permissions(
        ...
        if is_admin or is_mod:
            return {
                "allowed": True,
                "message": "Permission granted (admin/mod)"
            }
    ...
    async def _format_error_response(self, generation_result: Dict[str, Any]) -> Dict[str, Any]:
