...
class PersonalityIntegration:
    ...
    def is_identity_question(self, message: str) -> bool:
        ...
        identity_keywords = [
            # English
            "who are you", "what are you", "who is astra", "what is astra",
            "tell me about yourself", "introduce yourself", "about you",
            "who made you", "who created you", "your creator", "your developer",
            "what can you do", "your capabilities", "what are you capable of",
            "why were you created", "your purpose", "your mission",
            "astra who are you", "astra what can you do", "astra what are you capable of",
            
            # Arabic
            "من أنت", "ما أنت", "من صنعك", "من خلقك", "من طورك",
            "ماذا تستطيع أن تفعل", "ما قدراتك", "ما إمكانياتك",
            "عرف نفسك", "تحدث عن نفسك",
            
            # French  
            "qui êtes-vous", "qui es-tu", "qu'êtes-vous", "que vous êtes",
            "qui vous a créé", "qui t'a créé", "votre créateur",
            "que pouvez-vous faire", "vos capacités", "présentez-vous",
            
            # German
            "wer bist du", "wer sind sie", "was bist du", "was sind sie", 
            "wer hat dich gemacht", "wer hat dich erstellt", "dein schöpfer",
            "was kannst du", "deine fähigkeiten", "stell dich vor",
            
            # Spanish
            "quién eres", "qué eres", "quién te creó", "quién te hizo",
            "tu creador", "qué puedes hacer", "tus capacidades", "preséntate",
            
            # Italian
            "chi sei", "cosa sei", "chi ti ha creato", "chi ti ha fatto",
            "il tuo creatore", "cosa puoi fare", "le tue capacità", "presentati"
        ]
