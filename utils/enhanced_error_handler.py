    ...
    async def handle_command_error(self, ctx: commands.Context, error: commands.CommandError):
        ...
        try:
            if isinstance(error, commands.CommandNotFound):
                ...
                await ctx.send("❌ The requested resource was not found.", delete_after=10)
...
async def safe_send_message(channel, content: str = None, embed: discord.Embed = None, **kwargs):
...
async def safe_edit_message(message: discord.Message, content: str = None, embed: discord.Embed = None, **kwargs):
